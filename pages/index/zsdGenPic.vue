  ...
  <view class="com-pic-draw">
    ...
    <view class="input-item">
      ...
      <view class="text-area">
        <textarea
          v-model="cueword"
          placeholder="输入你想要的内容,支持中英文,用逗号分割."
          :maxlength="maxinput"
        ></textarea>
      </view>
    ...
    <view class="input-item">
      ...
      <view class="text-area">
        <textarea
          v-model="reverse"
          placeholder="输入你不想要的内容,支持中英文,用逗号分割."
          :maxlength="maxinput"
        ></textarea>
      </view>
      <view class="text-num-box">
    ...
    <view class="box-content ratio-box">
      ...
      <view class="ratio-content">
        <view
          class="ratio-list"
          v-for="(item, index) in sizeRatios"
          :key="index"
        >
          <view
            class="ratio-item"
            :class="item.selected ? 'ratio-sel' : ''"
    ...
    <view class="box-content generate-box">
      ...
      <view class="generate-content">
        <view
          class="generate-list"
          v-for="(item, index) in generates"
          :key="index"
        >
          <view
            class="generate-item"
            :class="item.selected ? 'generate-sel' : ''"
            @click="clickGenerateChange(item, index)"
          >
            {{ item.val }}张
          </view>
        </view>
    ...
    <view class="box-content quality-box">
      ...
      <view class="quality-content">
        <view
          class="quality-list"
          v-for="(item, index) in qualitys"
          :key="index"
        >
          <view
            class="quality-item"
            :class="item.selected ? 'quality-sel' : ''"
            @click="clickQualityChange(item, index)"
          >
            {{ item.title }}
          </view>
        </view>
    ...
    >
      ...
      <view class="result-content">
        <view
          class="res-img-box"
          v-for="(item, index) in generatesImages"
          :key="index"
